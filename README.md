...
| [`freight-operator`](packages/create-project/templates/freight-operator) | Email/PDF → Anydoc and OpenAI extraction → validation → human approval → McLeod PowerBroker order |
