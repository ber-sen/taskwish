...
async function runBenchmark(
  ...
  results.sequentialEcho = {
    ...
    callsPerSecond:
      (SEQUENTIAL_CALLS / (sequentialEchoEnd - sequentialEchoStart)) * 1000,
  };
  ...
  results.sequentialAdd = {
    ...
    callsPerSecond:
      (SEQUENTIAL_CALLS / (sequentialAddEnd - sequentialAddStart)) * 1000,
  };
  ...
  results.concurrentEcho = {
    ...
    callsPerSecond:
      (CONCURRENT_CALLS / (concurrentEchoEnd - concurrentEchoStart)) * 1000,
  };
  ...
  results.concurrentAdd = {
    ...
    callsPerSecond:
      (CONCURRENT_CALLS / (concurrentAddEnd - concurrentAddStart)) * 1000,
  };
  ...
  test(
    ...
    async () => {
      ...
      const worker = spawn("bun", [
        path.join(testsPath, "scripts/benchmark-api.ts"),
      ]);
