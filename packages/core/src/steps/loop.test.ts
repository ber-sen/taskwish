...
describe("Loop", () => {
  ...
  test("If inside loop filters items", async () => {
    ...
    expect(yields).toEqual([
      ...
      { ">": "branch.loop[0].if", condition: false },
      { ">": "branch.loop[1].if", condition: true },
      { ">": "branch.loop[1].if.even", result: 2 },
      { ">": "branch.loop[2].if", condition: false },
      { ">": "branch.loop[3].if", condition: true },
  ...
  test("If/Else inside loop tags every item", async () => {
    ...
    expect(yields).toEqual([
      ...
      { ">": "branch.loop[1].if", condition: false },
      { ">": "branch.loop[1].else" },
      { ">": "branch.loop[1].else.tag", result: "even:2" },
      { ">": "branch.loop[2].if", condition: true },
  ...
  test("If condition inside loop accesses outer scope", async () => {
    ...
    expect(yields).toEqual([
      ...
      { ">": "branch.loop[4].if", condition: true },
  ...
  test("ElseIf inside loop — three-way branch per item", async () => {
    ...
    expect(yields).toEqual([
      ...
      { ">": "branch.loop[0].if", condition: false },
      { ">": "branch.loop[0].elseIf", condition: false },
      { ">": "branch.loop[0].else" },
      { ">": "branch.loop[0].else.tag", result: "other" },
      { ">": "branch.loop[1].if", condition: false },
      { ">": "branch.loop[1].elseIf", condition: true },
      { ">": "branch.loop[1].elseIf.tag", result: "buzz" },
      { ">": "branch.loop[2].if", condition: true },
      { ">": "branch.loop[2].if.tag", result: "fizz" },
      { ">": "branch.loop[3].if", condition: false },
      { ">": "branch.loop[3].elseIf", condition: true },
      { ">": "branch.loop[3].elseIf.tag", result: "buzz" },
      { ">": "branch.loop[4].if", condition: false },
      { ">": "branch.loop[4].elseIf", condition: false },
      { ">": "branch.loop[4].else" },
  ...
  test("Loop inside Loop — If inside inner loop still filters", async () => {
    ...
    expect(yields).toEqual([
      ...
      { ">": "branch.outer[0].inner[0].if", condition: false },
      { ">": "branch.outer[0].inner[1].if", condition: true },
      { ">": "branch.outer[0].inner[1].if.even", result: 4 },
      { ">": "branch.outer[0].inner[2].if", condition: false },
      { ">": "branch.outer[0].inner[3].if", condition: true },
      { ">": "branch.outer[0].inner[3].if.even", result: 8 },
      { ">": "branch.outer[1].inner", items: [1, 2, 3, 4] },
      { ">": "branch.outer[1].inner[0].if", condition: false },
      { ">": "branch.outer[1].inner[1].if", condition: true },
  ...
  test("Loop > If > Loop — inner loop runs only for matching outer items", async () => {
    ...
    expect(yields).toEqual([
      ...
      { ">": "branch.outer[0].if", condition: false },
      { ">": "branch.outer[1].if", condition: true },
      ...
      { ">": "branch.outer[2].if", condition: false },
      { ">": "branch.outer[3].if", condition: true },
